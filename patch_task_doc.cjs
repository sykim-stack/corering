// patch_task_doc.cjs
const fs = require('fs');
const path = 'doc/tasks/TASK-DIALECT-EXPANSION.md';

const content = `# TASK: 남부 방언 사전(tp_translations) 확장
...
if (fs.existsSync(path)) {
  console.log('SKIP: doc/tasks/TASK-DIALECT-EXPANSION.md already exists (not overwritten)');
} else {
  fs.mkdirSync('doc/tasks', { recursive: true });
  fs.writeFileSync(path, content, 'utf8');
  console.log('OK: Task document created at doc/tasks/TASK-DIALECT-EXPANSION.md');
}
