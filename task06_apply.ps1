# ============================================================
# TASK-06: 홈페이지 SoftwareApplication JSON-LD 추가
...
Write-Host "TASK-06 시작: 홈페이지 JSON-LD 추가" -ForegroundColor Cyan

Write-Host ""
Write-Host "patch_seo_homepage_jsonld.cjs 실행..." -ForegroundColor Cyan
node patch_seo_homepage_jsonld.cjs
...
if ($confirm -eq 'y') {
    git add -A
    git commit -m "TASK-06: 홈페이지 SoftwareApplication JSON-LD 추가"
    git push
    Write-Host ""
